...
import com.invengo.rfidpad.debug.TagPasswordConfigDebugActivity;
...
public class MoreActivity extends PowerManagerActivity {
	...
	private void initializeListEntity() {
		...
		OperationEntity tagEncryptEntity = new OperationEntity(getString(R.string.title_tag_encrypt_configuration));
		tagEncryptEntity.setCls(TagEncryptConfigActivity.class);
		mList.add(tagEncryptEntity);
		OperationEntity tidLengthEntity = new OperationEntity(getString(R.string.title_tid_length_configuration));
		tidLengthEntity.setCls(TidLengthConfigActivity.class);
		mList.add(tidLengthEntity);
...
//			mList.add(tagFilterEntity);
			...
			OperationEntity tagPasswordEntity = new OperationEntity(getString(R.string.title_tag_password_configuration));
			tagPasswordEntity.setCls(TagPasswordConfigDebugActivity.class);
			mList.add(tagPasswordEntity);
		}
