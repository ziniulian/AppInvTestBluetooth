...
public class ReaderHolder {
	...
	public Reader createBluetoothLeReader(String readerName, String deviceName, Activity context){
		this.readerName = readerName;
		this.deviceName = deviceName;
		
		currentReader = new Reader(readerName, "BluetoothLE", deviceName, context);
		return currentReader;
	}
