...
import com.invengo.rfidpad.scan.tag6c.TagInactivateAllActivity;
...
public class Tag6COperationActivity extends PowerManagerActivity {
	...
	private void initializeListEntity() {
		...
		OperationEntity inactivateTagAllEntity = new OperationEntity(getString(R.string.text_tag_operation_inactivate_tag));
		inactivateTagAllEntity.setCls(TagInactivateAllActivity.class);
		mList.add(inactivateTagAllEntity);
